...
def products_routes(app):
    ...
    def show_company_products(id):
        ...
        """
        try:
            data = requests.get(f"http://127.0.0.1:8081/company/{id}/products")
            ...
            if "error" in response:
                return render_template(
                    "manage_products.html", error=response["error"], company_id=id
                )
            else:
    ...
    def show_edit_product_form(product_id):
        ...
        try:
            response = requests.get(
                f"http://127.0.0.1:8081/company/products/{product_id}"
            )
            ...
            return render_template(
                "edit_product.html", product=product_data, all_categories=category_data
            )
    ...
    def edit_product(company_id, product_id):
        ...
        try:
            ...
            response = requests.put(
                f"http://127.0.0.1:8081/company/products/{product_id}/edit",
                json=product_data,
            )
            ...
            if response.status_code == 200:
                ...
                return render_template(
                    "edit_product.html", product_id=product_id, error=error_message
                )
        except Exception as err:
            print(traceback.format_exc())
            print(f"{err}")
    ...
    def show_add_product_form(company_id):
        ...
        try:
            category_data = cache.category_repository.get_categories()
            return render_template(
                "add_product.html", company_id=company_id, all_categories=category_data
            )
        except Exception as err:
            print(traceback.format_exc())
            print(f"{err}")
    ...
    def add_product(company_id):
        ...
        try:
            ...
            response = requests.post(
                f"http://127.0.0.1:8081/company/{company_id}/products/add",
                json=product_data,
            )
    ...
    def delete_product(product_id):
        ...
        try:
            response = requests.delete(
                f"http://127.0.0.1:8081/company/products/{product_id}/delete"
            )
